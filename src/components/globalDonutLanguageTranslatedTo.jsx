...
function Donut  () {
    ...
    useEffect(() => {
        ...
        axios({
          method: 'GET',
          url: 'http://127.0.0.1:5000/globalStatisticsTranslateTo',
        })
          .then((response) => {
       ...
       // console.log("Codes",languageCodes);
       // console.log("Number",languageNumber);
    ...
    return(
        ...
        options={{
            ...
            legend: {
              ...
              title: {
                text: 'Most languages translated to in the last 30 days',
